 ...
 */
public class Plooter extends Enemy
{
    /**
     * Act - do whatever the Plooter wants to do. This method is called whenever
    ...
    public Plooter(){
        getImage().scale(35,35); // resizes the image
    }
    ...
    public void act() 
    {
        if(getWorld().getObjects(Hero.class).get(0) != null){
            ...
            if(startAttackT.millisElapsed() > 2300){
                shoot(); // shoots ever 2.3 seconds
                startTimer = true;
            }
            checkDeath();
        }
